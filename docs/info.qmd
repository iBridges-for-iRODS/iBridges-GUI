...
- `Browser`: a main table to browse through collections and inspect data, manilpulate metadata and User Permissions, up and download smaller data and to delete data.
...
-  `Info`: an overview over the iRODS server and iRODS client configuration listing user informatio such as groups and server information such as resources.
