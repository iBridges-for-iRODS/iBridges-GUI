...
class SearchThread(QThread):
    ...
    def run(self):
        ...
        search_out = {}
        try:
            search_out['results'] = search_data(self.thread_session, path=self.path,
...
class DownloadThread(QThread):
    ...
    def __init__(self, ienv_path, logger,
...
class SyncThread(QThread):
    ...
    def run(self):
        ...
        try:
            result = sync_data(self.thread_session, self.source, self.target,
