...
"")
        ...
        self.objects_radio = QtWidgets.QRadioButton(parent=tabSearch)
        self.objects_radio.setObjectName("objects_radio")
        self.horizontalLayout.addWidget(self.objects_radio)
        self.collections_radio = QtWidgets.QRadioButton(parent=tabSearch)
        self.collections_radio.setObjectName("collections_radio")
        self.horizontalLayout.addWidget(self.collections_radio)
        self.all_radio = QtWidgets.QRadioButton(parent=tabSearch)
        ...
        self.select_all_box = QtWidgets.QCheckBox(parent=tabSearch)
        ...
        tabSearch.setTabOrder(self.search_path_field, self.path_pattern_field)
        tabSearch.setTabOrder(self.path_pattern_field, self.checksum_field)
        tabSearch.setTabOrder(self.checksum_field, self.key1)
        tabSearch.setTabOrder(self.key1, self.val1)
        tabSearch.setTabOrder(self.val1, self.units1)
        tabSearch.setTabOrder(self.units1, self.key2)
        tabSearch.setTabOrder(self.key2, self.val2)
        tabSearch.setTabOrder(self.val2, self.units2)
        tabSearch.setTabOrder(self.units2, self.key3)
        tabSearch.setTabOrder(self.key3, self.val3)
        tabSearch.setTabOrder(self.val3, self.units3)
        tabSearch.setTabOrder(self.units3, self.key4)
        tabSearch.setTabOrder(self.key4, self.val4)
        tabSearch.setTabOrder(self.val4, self.units4)
        tabSearch.setTabOrder(self.units4, self.case_sensitive_box)
        tabSearch.setTabOrder(self.case_sensitive_box, self.search_button)
        tabSearch.setTabOrder(self.search_button, self.clear_button)
        tabSearch.setTabOrder(self.clear_button, self.load_more_button)
        tabSearch.setTabOrder(self.load_more_button, self.select_all_box)
        tabSearch.setTabOrder(self.select_all_box, self.download_button)
        tabSearch.setTabOrder(self.download_button, self.search_table)
    ...
    def retranslateUi(self, tabSearch):
        ...
        self.objects_radio.setText(_translate("tabSearch", "Data Objects"))
        self.collections_radio.setText(_translate("tabSearch", "Collections"))
        self.all_radio.setText(_translate("tabSearch", "all"))
        ...
        self.select_all_box.setText(_translate("tabSearch", "Select all"))
