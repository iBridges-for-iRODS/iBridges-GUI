...
"\n"
"")
        self.widget = QWidget(tabSearch)
        self.widget.setObjectName(u"widget")
        self.widget.setGeometry(QRect(10, 14, 1134, 822))
        ...
        self.search_path_field = QLineEdit(self.widget)
        ...
        self.path_pattern_field = QLineEdit(self.widget)
        ...
        self.checksum_field = QLineEdit(self.widget)
        ...
        self.units2 = QLineEdit(self.widget)
        ...
        self.key1 = QLineEdit(self.widget)
        ...
        self.object_box = QCheckBox(self.widget)
        self.object_box.setObjectName(u"object_box")
        self.object_box.setChecked(True)

        self.horizontalLayout_2.addWidget(self.object_box)

        self.collection_box = QCheckBox(self.widget)
        self.collection_box.setObjectName(u"collection_box")
        self.collection_box.setChecked(True)
        ...
        self.load_more_button = QPushButton(self.widget)
        ...
        self.select_all_box = QCheckBox(self.widget)
        ...
        self.download_button = QPushButton(self.widget)
        ...
        self.search_table = QTableWidget(self.widget)
    ...
    def retranslateUi(self, tabSearch):
        ...
        self.object_box.setText(QCoreApplication.translate("tabSearch", u"Data Objects", None))
        self.collection_box.setText(QCoreApplication.translate("tabSearch", u"Collections", None))
