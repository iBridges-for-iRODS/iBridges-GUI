...
class Ui_tabUpDownload(object):
    def setupUi(self, tabUpDownload):
        ...
        if getattr(sys, "frozen", False):
            icon.addPixmap(
                QtGui.QPixmap(r"../gui/ui_files/../icons/arrow-right.png"),
        ...
        if getattr(sys, "frozen", False):
            icon1.addPixmap(
                QtGui.QPixmap(r"../gui/ui_files/../icons/arrow-left.png"),
                QtGui.QIcon.Mode.Normal,
                QtGui.QIcon.State.Off,
            )
        else:
